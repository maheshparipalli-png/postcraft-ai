...
export default function AutoPublishPage() {
  ...
  return <main className="min-h-screen bg-[#f4f3ef] text-[#171717]"><div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
    ...
    <section className="border-b border-neutral-300/80 py-12 lg:py-16"><div className="mb-4 text-[11px] font-medium uppercase tracking-[0.2em] text-neutral-500">Manage · Recurring automation</div><h1 className="max-w-4xl font-serif text-5xl leading-[0.98] tracking-[-0.05em] sm:text-7xl">Control how your<br />posts get published.</h1><p className="mt-6 max-w-2xl text-base leading-7 text-neutral-600">Set the daily schedule, publishing mode, LinkedIn destination, and safety rules for PostCraft’s recurring automation.</p></section>
    ...
    <section className="grid gap-6 py-10 sm:grid-cols-3"><div><div className="text-[10px] uppercase tracking-[0.18em] text-neutral-500">01 · Schedule</div><p className="mt-3 text-sm leading-6 text-neutral-600">Choose when the daily workflow runs in IST.</p></div><div><div className="text-[10px] uppercase tracking-[0.18em] text-neutral-500">02 · Review</div><p className="mt-3 text-sm leading-6 text-neutral-600">Decide whether the prepared draft should wait for your approval.</p></div><div><div className="text-[10px] uppercase tracking-[0.18em] text-neutral-500">03 · Protect</div><p className="mt-3 text-sm leading-6 text-neutral-600">Verification, duplicate checks, and account access remain mandatory.</p></div></section>
  </div></main>;
}
