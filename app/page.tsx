...
export default function Home() {
  ...
  async function generateAngles(idea: Idea) {
    ...
    setAngleLoading(true); setAngle(""); setError(""); setSuggestedAngles([]); setEvidence([]);
    try {
      const selectedTopic = topic === "Custom topic" ? customTopic.trim() : topic;
