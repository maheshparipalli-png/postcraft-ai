...
export default function AutoPostPage() {
  ...
  async function regenerateDraft() {
    ...
    if (window.confirm("Regenerate today’s draft? The current unsent draft will be replaced.")) await prepareDraft(true);
  }
